...
public class MotorcycleEnterProductDataTricentisPage extends AbstractComponent{

	WebDriver driver;
	
	public MotorcycleEnterProductDataTricentisPage(WebDriver driver) {
		super(driver);
		this.driver = driver;
	  ...
	  @FindBy(id = "startdate")
	    ...
	    public void inputMotorcycleEnterProductDataTricentisPage() {
