...
public class TruckSendQuoteTricentisPage extends AbstractComponent{

	WebDriver driver;
	
	public TruckSendQuoteTricentisPage(WebDriver driver) {
		super(driver);
		this.driver = driver;
	 ...
	 @FindBy(id = "email")
	    ...
	    public void inputTruckSendQuoteTricentisPage() {
			...
			System.out.println("SELENIUM AUTOMATION entered inputTruckSendQuoteTricentisPage..");
	    }
}
