...
public class CamperEnterInsurantDataTricentisPage extends AbstractComponent {

	WebDriver driver;
	
	public CamperEnterInsurantDataTricentisPage(WebDriver driver) {
		super(driver);
		this.driver = driver;
    ...
    public void inputCamperEnterInsurantDataTricentisPage() {
