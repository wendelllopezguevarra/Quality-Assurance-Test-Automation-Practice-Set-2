...
public class AutomobileSendQuoteTricentisPage extends AbstractComponent{

	WebDriver driver;
	
	public AutomobileSendQuoteTricentisPage(WebDriver driver) {
		super(driver);
		this.driver = driver;
	 ...
	 @FindBy(id = "email")
	    ...
	    public void inputAutomobileSendQuoteTricentisPage() {
			...
			System.out.println("SELENIUM AUTOMATION entered inputAutomobileSendQuoteTricentisPage..");
	    }
}
