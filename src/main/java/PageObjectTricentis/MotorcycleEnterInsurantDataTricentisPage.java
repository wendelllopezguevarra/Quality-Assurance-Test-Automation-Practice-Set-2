...
public class MotorcycleEnterInsurantDataTricentisPage extends AbstractComponent {

	WebDriver driver;
	
	public MotorcycleEnterInsurantDataTricentisPage(WebDriver driver) {
		super(driver);
		this.driver = driver;
    ...
    public void inputMotorcycleEnterInsurantDataTricentisPage() {
