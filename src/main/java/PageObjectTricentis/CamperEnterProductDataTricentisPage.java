...
public class CamperEnterProductDataTricentisPage extends AbstractComponent{

	WebDriver driver;
	
	public CamperEnterProductDataTricentisPage(WebDriver driver) {
		super(driver);
		this.driver = driver;
	  ...
	  @FindBy(id = "startdate")
	    ...
	    public void inputCamperEnterProductDataTricentisPage() {
