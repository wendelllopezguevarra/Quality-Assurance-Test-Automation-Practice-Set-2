...
public class MotorcycleSendQuoteTricentisPage extends AbstractComponent{

	WebDriver driver;
	
	public MotorcycleSendQuoteTricentisPage(WebDriver driver) {
		super(driver);
		this.driver = driver;
	 ...
	 @FindBy(id = "email")
	    ...
	    public void inputMotorcycleSendQuoteTricentisPage() {
			...
			System.out.println("SELENIUM AUTOMATION entered inputMotorcycleSendQuoteTricentisPage..");
	    }
}
