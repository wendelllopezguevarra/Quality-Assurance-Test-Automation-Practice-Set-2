...
public class TruckEnterInsurantDataTricentisPage extends AbstractComponent {

	WebDriver driver;
	
	public TruckEnterInsurantDataTricentisPage(WebDriver driver) {
		super(driver);
		this.driver = driver;
    ...
    public void inputTruckEnterInsurantDataTricentisPage() {
