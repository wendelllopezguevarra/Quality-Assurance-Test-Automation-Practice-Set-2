...
public class TruckSelectPriceOptionTricentisPage extends AbstractComponent{

	WebDriver driver;
	
	public TruckSelectPriceOptionTricentisPage(WebDriver driver) {
		super(driver);
		this.driver = driver;
	...
	public void inputTruckSelectPriceOptionTricentisPage() {
